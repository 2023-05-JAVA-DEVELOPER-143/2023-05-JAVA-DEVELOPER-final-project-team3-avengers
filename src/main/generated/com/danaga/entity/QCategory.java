...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = -172372046L;
    ...
    public final ListPath<Category, QCategory> childTypes = this.<Category, QCategory>createList("childTypes", Category.class, QCategory.class, PathInits.DIRECT2);
