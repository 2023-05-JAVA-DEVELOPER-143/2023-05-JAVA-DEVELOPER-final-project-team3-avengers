...
public class CartServiceImpl implements CartService {
	...
	/*public void addCart(Cart cart) {
		// isDuplicateOptionset = checkOptionSet(cart.getOptionSet().getId());
		if (isDuplicateOptionset) {
			// 장바구니에 담긴 상품 ->
			// cartCqy 1증가
	...
	@Override
	public List<Cart> getCarts(String memberId) {
		return cartDao.getCarts(memberId);
	}*/
